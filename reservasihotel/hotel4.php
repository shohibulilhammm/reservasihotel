...
$nama_hotel = "Metland Hotel Cirebon"; // Tambahkan variabel dengan nama hotel
...
<br> <br> <br>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="4.jpg" class="img-fluid" alt="Hotel 4">
            </div>
            <div class="col-md-6">
                <h2><?php echo $nama_hotel; ?></h2> <!-- Tampilkan nama hotel -->
                <p>
                    Selamat datang di <?php echo $nama_hotel; ?>! Hotel kami terletak di kota Cirebon dan menawarkan kenyamanan serta pelayanan yang istimewa.
                </p>
                <p>
                    Fasilitas:
                    <ul>
                        <li>Kolam renang</li>
                        <li>Restoran dengan berbagai pilihan kuliner</li>
                ...
                <p>
                    Nikmati pengalaman menginap yang tak terlupakan di <?php echo $nama_hotel; ?>. Kami berkomitmen untuk memberikan kualitas terbaik kepada tamu-tamu kami.
                </p>
